...
let spaceShuttle = new Spacecraft('Alpha', 17500);


// Move your output statements from part 3 here. Update the template literals use the
// instance of the class.

console.log(`It will take ${Spacecraft.name} ${getDaysToLocation(kilometersToMars)} days to get to Mars`);
console.log(`It will take ${Spacecraft.name} ${getDaysToLocation(kilometersToTheMoon)} days to get to the Moon.`);
